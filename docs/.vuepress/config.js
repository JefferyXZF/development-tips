...
module.exports = {
  title: "前端开发技巧",
  description: '整理、收集、沉淀前端开发技巧，提高效率',
  base: '/development-tips/', // '/<仓库名>/'， 默认'/'
  ...
  themeConfig: { // 主题配置
    ...
    repo: 'JefferyXZF/development-tips', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: 'Jeffery', // 必需
      href: 'https://github.com/JefferyXZF' // 可选的
    },
    ...
    footer:{ // 页脚信息
      ...
      copyrightInfo: '前端老司机 | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
  plugins: [ // 插件
